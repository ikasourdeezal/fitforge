import { BlogCard2 } from "components/common/Card";

import Img1 from "styles/images/blogpage/1.jpg";
import Img2 from "styles/images/blogpage/2.jpg";
import Img3 from "styles/images/blogpage/3.jpg";
import Img4 from "styles/images/blogpage/4.jpg";
import Img5 from "styles/images/blogpage/5.jpg";
import Img6 from "styles/images/blogpage/6.jpg";
import Img7 from "styles/images/blogpage/7.jpg";
import Recent1 from "styles/images/blogpage/recent1.jpg";
import Recent2 from "styles/images/blogpage/recent2.jpg";
import Recent3 from "styles/images/blogpage/recent3.jpg";
import Recent4 from "styles/images/blogpage/recent4.jpg";
import Recent5 from "styles/images/blogpage/recent5.jpg";
import Recent6 from "styles/images/blogpage/recent6.jpg";
    ...
    return (
        <>
            <section>
                ...
                <div className="py-[10rem] container gap-16 page_padding grid grid-cols-[64fr_35fr] md1000:grid-cols-1 md1000:gap-32">
                    ...
                    <div>
                        ...
                        {/* categories */}
                        <div className="flex flex-col my-[35px] p-[30px] bg-[#f8f8f8]">
                            ...
                            <div className="flex flex-col gap-7">
                                ...
                                <div className="flex gap-8">
                                    ...
                                    <div className="flex flex-col gap-4 justify-center">
                                        ...
                                        <p className="text-[16px] text-black hover:text-[#ff0336] ease-in duration-200 cursor-pointer font-bold">
                                            The best are European Meditation
                                            Practitioner
                                        </p>
                                    </div>
                                </div>
                        ...
                        {/* banner */}
                        <div className="blog_banner w-full h-[56rem] relative">
                            <p className="text-[34px] font-bold uppercase absolute z-[2] left-10 top-16">
                                gymat
                            </p>
                            <span className="banner_shape w-[18rem] bg-white top-14 left-0 h-[60px] absolute z-[1]"></span>
